...
const Admindashboardinvestmentdetail = () => {
  const { id } = useParams();
  ...
  function getInvestment() {
    ...
    fetch(`${process.env.REACT_APP_FETCH_URL_}/api/admin/get-investment-detail`, {
      method: "GET",
      headers: {
        "id": id,
        'token': token,
...
export default Admindashboardinvestmentdetail